...
public class ConsumerDemo {
    public static void main(String[] args) {
        ...
        consumer.subscribe(Collections.singleton(topic)); //Singletom mean that we will subscribe to only single topic

        //If we want to subscibe for multiple topoic then we can use below
